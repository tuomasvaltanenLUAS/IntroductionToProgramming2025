...
for hotel in hotels:
    ...
    # services is another list inside one hotel, we need a loop
    # for service in hotel['services']:
    #     print(service)

    # because services is just another text list in a hotel
    # we have an option => join() -function
    # this is considered a good practice => it's easy to understand
    # and we avoid adding one extra level of loops this way
    services = "\n".join(hotel['services'])
    print(services)
